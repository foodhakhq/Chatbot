...
log_file_path = '/tmp/chatbot-production.log'
...
redis_host = os.getenv('PRODUCTION_REDIS_HOST', '10.164.177.83')
redis_port = int(os.getenv('PRODUCTION_REDIS_PORT', 6379))
...
def start_session():
    try:
        ...
        model_choice = "gemini"  # Adjust as needed
...
@app.route('/chat/end_session', methods=['POST'])
@require_api_key
def end_session():
    try:
